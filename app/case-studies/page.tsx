  ...
  const caseStudies = [
    {
      ...
      testimonial: "Yvonne väntee hela vår organisation på 18 månader. Hennes kombinantion av strategiskt tänkande och praktisk genomförandekraft var avgörande för vår framgång.",
